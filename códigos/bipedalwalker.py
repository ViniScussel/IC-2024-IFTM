...
def monitor_resources():
    ...
    list_cpu.append(psutil.cpu_percent())
    list_mem.append(memory_info.rss / (1024 * 1024))
...
for learn_rate in [0.02, 0.04, 0.06, 0.08]:
    ...
    for episode in range(episodes):
        ...
        list_of_rewards.append(reward_eval)
        list_of_ep.append(episode)
        if episode % 100 == 0:
            ...
            print('\n')
        monitor_resources()
        if episode == 1500 or episode == 1499:
            print(list_cpu)
            print("-------------------------------------------------------------------------------------")
            print(list_mem)
    print(theta)
