...
<a>Portanto, o algorítmo não passa de uma operação linear que, por reforço, "acha" os mínimos da função sem necessidade de programar _Bacpropagation_ e nem _Postpropagation_, que aumentaria em dificuldade uso de processamento, mas, em contrapartida, é menos eficiente que uma rede neural completa.</a>
